...
export const translations: Translations = {
  ...
  'a11y.toolbar.label': { en: 'Accessibility options', ar: 'خيارات إمكانية الوصول' },
  'a11y.toolbar.highContrast': { en: 'High contrast mode', ar: 'وضع التباين العالي' },
  'a11y.toolbar.highContrastOn': { en: 'High contrast mode enabled', ar: 'وضع التباين العالي مفعّل' },
  'a11y.toolbar.highContrastOff': { en: 'High contrast mode disabled', ar: 'وضع التباين العالي معطّل' },
  'a11y.toolbar.fontSizeGroup': { en: 'Text size controls', ar: 'التحكم بحجم النص' },
  'a11y.toolbar.decreaseFont': { en: 'Decrease text size', ar: 'تصغير حجم النص' },
  'a11y.toolbar.increaseFont': { en: 'Increase text size', ar: 'تكبير حجم النص' },
  'a11y.toolbar.resetFont': { en: 'Reset text size', ar: 'إعادة حجم النص الافتراضي' },
